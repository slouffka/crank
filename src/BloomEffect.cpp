...
, mSecondPassTextures()
{
    mShaders.load(Shaders::BrightnessPass,      "res/shaders/fullpass.vert", "res/shaders/brightness.frag");
    mShaders.load(Shaders::DownSamplePass,      "res/shaders/fullpass.vert", "res/shaders/down-sample.frag");
    mShaders.load(Shaders::GaussianBlurPass,    "res/shaders/fullpass.vert", "res/shaders/gaussian-blur.frag");
    mShaders.load(Shaders::AddPass,             "res/shaders/fullpass.vert", "res/shaders/add.frag");
}
